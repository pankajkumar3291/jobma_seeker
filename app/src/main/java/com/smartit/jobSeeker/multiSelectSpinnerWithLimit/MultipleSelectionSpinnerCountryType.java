...
public class MultipleSelectionSpinnerCountryType extends AppCompatSpinner implements
    ...
    public MultipleSelectionSpinnerCountryType(Context context) {
        super(context);
    ...
    public MultipleSelectionSpinnerCountryType(Context context, AttributeSet attrs) {
        super(context, attrs);
