...
public class MultipleSelectionSpinnerCurrencyType extends AppCompatSpinner implements
    ...
    public MultipleSelectionSpinnerCurrencyType(Context context) {
        super(context);
    ...
    public MultipleSelectionSpinnerCurrencyType(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//            simple_adapter.add(buildSelectedItemString());
            ...
            if (buildSelectedItemString().length() > 0) {
                ...
                simple_adapter.add("Currency Type");
            }
            ...
            if (isChecked) {
                ...
                if (selectedPosition > 0) {
                    ...
                    selectedPosition -= simple_adapter.getCount();
//                    Toast.makeText(App.context, "Maximum 1 can be select", Toast.LENGTH_SHORT).show();
