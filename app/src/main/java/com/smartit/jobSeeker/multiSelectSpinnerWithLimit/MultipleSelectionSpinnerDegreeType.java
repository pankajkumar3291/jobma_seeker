...
public class MultipleSelectionSpinnerDegreeType extends AppCompatSpinner implements
    ...
    public MultipleSelectionSpinnerDegreeType(Context context) {
        super(context);
    ...
    public MultipleSelectionSpinnerDegreeType(Context context, AttributeSet attrs) {
        super(context, attrs);
