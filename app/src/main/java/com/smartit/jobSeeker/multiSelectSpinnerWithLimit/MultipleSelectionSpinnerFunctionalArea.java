...
public class MultipleSelectionSpinnerFunctionalArea extends AppCompatSpinner implements
    ...
    public MultipleSelectionSpinnerFunctionalArea(Context context) {
        super(context);
    ...
    public MultipleSelectionSpinnerFunctionalArea(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                simple_adapter.add("Select Functional Area");
            }
