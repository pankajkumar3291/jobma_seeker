...
public class MultipleSelectionSpinnerIndustries extends AppCompatSpinner implements
    ...
    public MultipleSelectionSpinnerIndustries(Context context) {
        super(context);
    ...
    public MultipleSelectionSpinnerIndustries(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//            simple_adapter.add(buildSelectedItemString());
            ...
            if (buildSelectedItemString().length() > 0) {
                ...
                simple_adapter.add("Select Industry Area");
            }
