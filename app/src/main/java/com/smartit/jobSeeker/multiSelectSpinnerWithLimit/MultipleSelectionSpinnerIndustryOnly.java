...
public class MultipleSelectionSpinnerIndustryOnly extends AppCompatSpinner implements
    ...
    public MultipleSelectionSpinnerIndustryOnly(Context context) {
        super(context);
    ...
    public MultipleSelectionSpinnerIndustryOnly(Context context, AttributeSet attrs) {
        super(context, attrs);
