...
public class MultipleSelectionSpinnerSalaryType extends AppCompatSpinner implements
    ...
    public MultipleSelectionSpinnerSalaryType(Context context) {
        super(context);
    ...
    public MultipleSelectionSpinnerSalaryType(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//            simple_adapter.add(buildSelectedItemString());
            ...
            if (buildSelectedItemString().length() > 0) {
                ...
                simple_adapter.add("Salary Type");
            }
