...
public class MultipleSelectionSpinnerStateType extends AppCompatSpinner implements
    ...
    public MultipleSelectionSpinnerStateType(Context context) {
        super(context);
    ...
    public MultipleSelectionSpinnerStateType(Context context, AttributeSet attrs) {
        super(context, attrs);
